...
if (SERVER) then
	function ENT:Initialize()
		self:SetModel("models/illusion/eftcontainers/bitcoin.mdl")
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		drawText("Coins made of miscellaneous metal.", x, y + 16, colorAlpha(color_white, alpha), 1, 1, nil, alpha * 0.65)
	end
end
