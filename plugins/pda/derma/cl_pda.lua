...
function PANEL:Init()
    ...
    self.Paint = function()
        ...
        surface.SetMaterial(Material("materials/holo2.png"))
    ...
    self.Scroll.Settings:SetFont("nutSmallBoldFont")
    ...
    self.Scroll.Close:SetFont("nutSmallBoldFont")
...
function PANEL:CreateLeaderboard() 
    ...
    self.Content.Paint = function(self, w, h)
        draw.NoTexture()    --nil should be "nutSmallFont"
        draw.SimpleText("Leaderboard", "nutSmallFont", w/2, 7, Color(0,0,0,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end
...
function PANEL:CreateSettings() 
    self.Content.Paint = function(self, w, h)
        draw.NoTexture()
        draw.SimpleText("Settings", "nutSmallFont", w/2, 7, Color(0,0,0,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end
    ...
    pdaLabel:SetText("Holopad Settings")
    pdaLabel:SetColor(Color(0,0,0,255))
    ...
    netHandleLabel:SetText("Holonet Handle: Your handle on the holonet and it's related services.")
    netHandleLabel:SetColor(Color(0,0,0,255))
    ...
    netHandleLabel.PaintOver = function(sel,w,h)
        ...
        draw.SimpleText("Your current handle: "..self.pda:getData("pdahandle", "invalid"), "nutSmallFont", 0, h+15, Color(0,0,0,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM)
