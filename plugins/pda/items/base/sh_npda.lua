...
ITEM.functions.open = {
    name = "Open Holopad",
    tip = "Open the GUI for this Holopad.",
...
ITEM.functions.zfindid = {
    name = "Find Identification Number",
    tip = "Find ID of this Holopad.",
    icon = "icon16/drive_edit.png",
    onRun = function(item)
        item.player:notify("ID of Holopad: "..tostring(item:getData("simid")))
        return false
    end,
	onCanRun = function(item)
		return true
